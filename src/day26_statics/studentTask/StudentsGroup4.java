...
public class StudentsGroup4 { // StudentsGroup3 HAS A Student
    ...
    public StudentsGroup4(String groupName, int groupId) { // you don't need to pass the ArrayList elements within the constructor
